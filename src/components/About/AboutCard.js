        ...
        <blockquote className="blockquote mb-0">
          {language === "en" &&
            <p style={{ textAlign: "justify" }}>
              Hi, I am <span className="goldenYellow">LU, Shaohao </span>
              from <span className="goldenYellow"> Zhuhai, Guangdong, China.</span> I am a both software engineer and algorithm engineer.
              <br /> I got both the bachelor and the master degree in <span className="goldenYellow">Sun-Yat-Sen University. </span>
          ...
          }
          {
            language === "zh" &&
            <p style={{ textAlign: "justify" }}>
              嗨，我是<span className="goldenYellow">卢少豪</span>, 来自<span className="goldenYellow">中国广东珠海</span>。 我是一位软件工程师兼算法工程师.
              我在<span className="goldenYellow">中山大学</span>获得学士和硕士学位。这个个人站是我用来分享我日常生活，学习，旅游过程中的文字，图片，视频，记录我一步步成长的脚步。
          ...
          <h2> <span className="goldenYellow">{text[language].socialmedia}</span> </h2>
          <div> 
